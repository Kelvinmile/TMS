...
ResultSet rs;
    ...
    public void jTable1(){
        try{
            String sql = "SELECT `ID`, `Name`, `Contact`, `Sex`, `Plan`, `Location`, `Email` FROM `customer`";
        ...
        public void Search(){
        try{
        String sql = "SELECT `ID`, `Name`, `Contact`, `Sex`, `Plan`, `Location`, `Email` FROM `customer` WHERE Contact=?";
        pst=conn.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        btnBack.setText("BACK ADMIN PAGE");
        ...
        jTextField3.setFont(new java.awt.Font("Arial Narrow", 0, 11)); 
        ...
        jTextField4.setFont(new java.awt.Font("Arial Narrow", 0, 11)); 
    ...
    private void btnAddEmpActionPerformed(java.awt.event.ActionEvent evt) {
        try{
        String sql = "INSERT INTO `customer`(`ID`, `Name`, `Contact`, `Sex`, `Plan`, `Location`, `Email`) VALUES (?,?,?,?,?,?,?)";
         pst=conn.prepareStatement(sql);
